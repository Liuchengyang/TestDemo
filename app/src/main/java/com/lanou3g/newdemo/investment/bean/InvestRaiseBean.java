...
public class InvestRaiseBean {
    ...
    public static class DataBean {
        ...
        public List<DataBean5> getData() {
            return data;
        }

        public void setData(List<DataBean5> data) {
            this.data = data;
        }

        public static class DataBean5 {
