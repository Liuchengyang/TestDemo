 ...
 */
public class InvestComAdapter extends BaseAdapter {
    private InvestFSBean bean;
    private Context context;

    public InvestComAdapter(Context context) {
        this.context = context;
    }

    public void setBean(InvestFSBean bean) {
        this.bean = bean;
    }
