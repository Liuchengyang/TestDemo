...
public class StringUrl {
    ...
    public static final String investFragmentAll="https://rong.36kr.com/api/mobi/cf/actions/list?page=1&type=all&pageSize=20";
    public static final String investFragmentFundraisingIn="https://rong.36kr.com/api/mobi/cf/actions/list?page=1&type=underway&pageSize=20";
